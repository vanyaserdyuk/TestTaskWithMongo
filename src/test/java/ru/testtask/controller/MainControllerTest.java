...
public class MainControllerTest {
    ...
    public void postProjectTest() throws Exception {
        Project project = Project.builder().id("a").name("prj").ownerId("1")
    ...
    public void putProjectTest() throws Exception {
        Project project = Project.builder().id("a").name("prj").ownerId("1").build();
    ...
    public void getAllProjectsTest() throws Exception {
        Project project = Project.builder().id("a").name("prj").ownerId("1")
                .attributes(new ArrayList<>()).geometries(new ArrayList<>()).build();
        Project project1 = Project.builder().id("b").name("prj1").ownerId("2")
                .attributes(new ArrayList<>()).geometries(new ArrayList<>()).build();
